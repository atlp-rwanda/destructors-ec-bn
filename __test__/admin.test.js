...
const createUser = User.User.create({
  ...
  it('should return 403 if user is not an admin', async () => {
    ...
    const response = await request(app)
      ...
      .set('Authorization', "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7ImZpcnN0bmFtZSI6Im15Zmlyc3RuYW1lIiwibGFzdG5hbWUiOiJteXNlY29uZG5hbWUiLCJlbWFpbCI6InRlc3RlbWFpbDEyMzRAZ21haWwuY29tIiwicGFzc3dvcmQiOiJ0ZXN0cGFzczIzNDUifSwiaWF0IjoxNjc5MzA2MTU2fQ.c1yIElDbYBGHkGoB2jS7pcOs2EG3_OJGZdqeSJTaGIw" )
  ...
  it('should return 404 if user to update is not found', async () => {
    const adminpyload = await User.User.findOne({where: {email:'admin@gmail.com'}})
