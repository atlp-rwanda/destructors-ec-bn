...
const resetEmail = async (req, res) => {
  try {
    ...
    if (user == false) {
      ...
      const HTMLText = `<p style='font-size: 15px'><strong> Hi <br> <br>
           Please click on this <a href="${link}"><span style="color: blue">Link</span></a> to reset your password. <br> <br>Remember, beware of scams and keep this one-time verification link confidential.<br>
